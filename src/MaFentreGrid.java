...
public class MaFentreGrid extends JFrame{
    ...
    conteneurPrincipal.setLayout(new GridLayout(2, 2, 40, 20));
 ...
 //   cliquez.setBounds(200, 70, 160, 40);
  ...
  //  cochez.setBounds(200, 120, 160, 30);
    ...
    public static void main(String[] args) {
        ...
        MaFentreGrid maFenetre = new MaFentreGrid();
